...
Maintainers will acknowledge a report when it has been reviewed, investigate
the impact, and coordinate disclosure after a fix is available. This project
...
GradWindow is a continuously deployed web application. Security fixes target
the current `main` branch and the live deployment; older repository snapshots
are not maintained as supported releases.
