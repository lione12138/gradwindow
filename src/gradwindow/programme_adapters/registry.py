...
from .hunan import HunanAdapter
...
from .lshtm import LSHTMAdapter
...
from .mainz import MainzAdapter
from .manchester import ManchesterAdapter
from .mayo_clinic import MayoClinicAdapter
...
from .normale_superiore import NormaleSuperioreAdapter
...
from .soochow_china import SoochowChinaAdapter
...
from .uestc import UESTCAdapter
...
from .virginia import VirginiaAdapter
...
from .zhengzhou import ZhengzhouAdapter
...
PROGRAMME_ADAPTERS: dict[str, AdapterFactory] = {
    ...
    "aix-marseille": AixMarseilleAdapter,
    "anu": ANUAdapter,
    "antwerp": AntwerpAdapter,
    "arizona": ArizonaAdapter,
    ...
    "grenoble-alpes": GrenobleAlpesAdapter,
    ...
    "montpellier": MontpellierAdapter,
    ...
    "nwpu": NPUAdapter,
    "ntu": NTUAdapter,
    "normale-superiore": NormaleSuperioreAdapter,
    ...
    "snu": SNUAdapter,
    "soochow-china": SoochowChinaAdapter,
    ...
    "zju": ZJUAdapter,
    "zhengzhou": ZhengzhouAdapter,
    "alberta": AlbertaAdapter,
    "ksu": KSUAdapter,
    "vienna": ViennaAdapter,
    "virginia": VirginiaAdapter,
