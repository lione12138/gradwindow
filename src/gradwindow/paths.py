...
RECURRING_WINDOWS_PATH = DATA_DIR / "recurring-windows.json"
REFRESH_STATUS_PATH = DATA_DIR / "refresh-status.json"
...
PROGRAMME_ADAPTER_HEALTH_PATH = OPS_DIR / "programme-adapter-health.json"
